...
export default function Hero() {
  ...
  return (
    ...
    >
      ...
      <div className="flex w-full max-w-6xl flex-col gap-6 py-6">
        <h1 className="font-poster text-left text-[13vw] uppercase leading-[0.88] tracking-tight text-ink md:text-[7vw]">
          {site.name}
        </h1>
        <p className="max-w-md font-mono text-sm uppercase tracking-wider text-ink-dim md:text-base">
          {site.role} — {site.tagline}
        </p>

        <div className="mt-6 grid grid-cols-1 gap-6 sm:grid-cols-2 md:max-w-2xl">
